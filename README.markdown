...
`curl -L https://raw.github.com/adamNewell/oh-my-zsh/master/tools/install.sh | sh`

#### via wget

`wget https://raw.github.com/adamNewell/oh-my-zsh/master/tools/install.sh -O - | sh`
